...
class MainActivity : ComponentActivity(), TextToSpeech.OnInitListener {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                if (showAiDisclaimer) {
                    AlertDialog(
                        ...
                        text = {
                            Text(
                                "AI can make mistakes. Hazard results are generated by AI and may not always be correct. " +
                                        "Always check your surroundings carefully and ask a trusted adult if you are unsure."
                            )
                        },
                        confirmButton = {
                            Button(
    ...
    fun MainContent(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            Text(
                text = "AI can make mistakes. Always ask a trusted adult if you are unsure.",
                fontSize = 13.sp,
                color = Color.Black,
                modifier = Modifier
                    .fillMaxWidth()
